...
uint32_t backclut[256] = {
    0x00000B18, 0xFF449674, 0xFF2F4361, 0xFF3C2854, 0xFF71467B, 0xFF192640, 0xFF2C6264, 0xFF4D4D6A,
    0xFF213456, 0xFF2C585B, 0xFF314877, 0xFF2C2454, 0xFF253464, 0xFF13142D, 0xFF613B72, 0xFF6F6984,
    0xFF241739, 0xFF403866, 0xFF1F2952, 0xFF52546E, 0xFF404762, 0xFF2E3956, 0xFF181C3F, 0xFF403C7B,
    0xFFC9C6D0, 0xFF3E4986, 0xFF253B65, 0xFF33537C, 0xFF141B33, 0xFF946C96, 0xFF2E4B63, 0xFF6D5B7D,
    0xFF5854A0, 0xFF9995A6, 0xFFFCFEFC, 0xFF9CAABC, 0xFF536580, 0xFF848DA4, 0xFF377A67, 0xFFAE8CAE,
    0xFFC5ADC4, 0xFFA279A1, 0xFFE0D0E0, 0xFF75798E, 0xFF63718A, 0xFF979EAD, 0xFF446698, 0xFF604480,
    0xFF835889, 0xFF1C0E29, 0xFF616683, 0xFFA49EB4, 0xFF44536B, 0xFF7D728C, 0xFF5F5A74, 0xFF3E5685,
    0xFF50366C, 0xFF524489, 0xFF2D2A5F, 0xFF533874, 0xFF413166, 0xFFBCB7C4, 0xFF241D48, 0xFFB4B2CC,
...
int main(int argc, char *argv[]) {
    ...
    backgroundPlane = gfx_getbbuffer1();
    //LoadPPB("res/ast1.ppb", backgroundPlane);
    volatile uint8_t *bkbitmap;

    bkbitmap = backgroundPlane->bitmap;
    LoadPPB("res/astbacks.ppb", bkbitmap);

    gfx_usebuffer(backgroundPlane);
    gfx_cls();
    gfx_setcolour(12);
    gfx_rectf(20,20,80,80);

    //backgroundPlane = gfx_
    ...
    LoadPPB("res/ast1.ppb", rockybottom);
    ...
    for(;;) {
        ...
        gfx_usebuffer(backgroundPlane);
        gfx_setcolour(panSound & 63);
        gfx_rectf(20 + (panSound & 255),20,48,48);
